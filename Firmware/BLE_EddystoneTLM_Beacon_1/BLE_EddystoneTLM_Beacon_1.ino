...
#define BEACON_UUID "3059d6b2-b5b3-404d-8dba-f0302de9cbec" // UUID 1 128-Bit (may use linux tool uuidgen or random numbers via https://www.uuidgenerator.net/)
...
void setBeacon()
{
  ...
  uint16_t volt = 2900; 
  float tempFloat = random(1500, 3000) / 100.0f;
  ...
  oAdvertisementData.setName("TLMBeacon_1");
...
void setup()
{
  ...
  delay(10000);
  pAdvertising->stop();
  Serial.printf("Enter deep sleep for 3s\n");
